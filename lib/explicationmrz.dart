                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInstructionStep('1. Placez la carte dans un endroit lumineux'),
                      _buildInstructionStep('2. Retournez la carte si nécessaire'),
                      _buildInstructionStep('3. Positionnez votre document à plat'),
                      _buildInstructionStep('4. Alignez le bord du document dans le cadre'),
                      _buildInstructionStep('5. Maintenez stable pendant la détection'),
                    ],
                  ),
                ),
              ),
